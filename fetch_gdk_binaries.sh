...
TAGNAME="release_0.0.58.post1"
URL="https://github.com/Blockstream/gdk/releases/download/${TAGNAME}/${TARBALL}"
SHA256="1e975d9b277873cfc9873034cf378c999f5fcfeca14c592cc8f38ebbd971584c"
...
JNILIBSDIR=${MODULE_ROOT}/src/main/jniLibs
GDK_JAVA_DIR="${MODULE_ROOT}/src/main/java/com/blockstream"

# Clean up any previous install
rm -rf gdk-android-jni* ${MODULE_ROOT}/src/main/jniLibs \
...
mv ${NAME}/lib/ ${MODULE_ROOT}/src/main/jniLibs/
